...
let puzzle1Tests =
    testList "Puzzle 1" [
        ...
        testCase "Puzzle question 1" <| fun _->
            Expect.equal (evaluateBunnyHeadquatersDistance puzzleQuestion) 299 "Puzzle question 1"
    ] 
...
let puzzle2Tests =
    testList "Puzzle 2" [
        ...
        testCase "Puzzle question 2" <| fun _->
            Expect.equal (evaluateBunnyHeadquatersDistance2 puzzleQuestion) 181 "Puzzle question 2"
    ]